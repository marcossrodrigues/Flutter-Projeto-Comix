...
class TelaAventura extends StatefulWidget {
  @override
  State<TelaAventura> createState() => _TelaAventuraState();
}

class _TelaAventuraState extends State<TelaAventura> {
  ...
  fetchComics() async{
    QuerySnapshot qn =
    await firestoreRef.collection(collectionName).where('genero', isEqualTo: 'Aventura').get();
    setState(() {
