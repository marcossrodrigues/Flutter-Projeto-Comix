...
class TelaInfantil extends StatefulWidget {
  @override
  State<TelaInfantil> createState() => _TelaInfantilState();
}

class _TelaInfantilState extends State<TelaInfantil> {
  ...
  fetchComics() async{
    QuerySnapshot qn =
    await firestoreRef.collection(collectionName).where('genero', isEqualTo: 'Infantil').get();
    setState(() {
