...
class RegistrationUsuario extends StatefulWidget {
  const RegistrationUsuario({Key? key}) : super(key: key);

  @override
  State<RegistrationUsuario> createState() => _RegistrationUsuarioState();
}

class _RegistrationUsuarioState extends State<RegistrationUsuario> {
  ...
  Widget build(BuildContext context) {
    ...
    // role
    final roleUsuario = DropdownButton<String>(
...
postDetailsToFirestore(String email, String rool) async{
  ...
  usuarioModel.uid = user!.uid;
  usuarioModel.role = rool;
  ...
  Navigator.pushAndRemoveUntil(context,MaterialPageRoute(builder: (context) => HomeComix()), (route) => false);
